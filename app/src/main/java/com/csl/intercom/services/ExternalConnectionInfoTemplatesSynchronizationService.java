...
public class ExternalConnectionInfoTemplatesSynchronizationService {
    ...
    public ExternalConnectionInfoTemplatesSynchronizationService(ScanApiHandler scanApiHandler, DbapiHandler dbapiHandler, long synchronizationIntervalSeconds) {
