...
public class CSLWebSocketForAlert {
...
//
//   
//    static String socketName="ALERT";
//
...
//    public static void broadcastMessageJson( String tag2, Json j) {
//    	
//    	Json jx=Json.object();
//    	jx.set("alert", j);
...
//            	
//            	//String s="";
//            			//String.valueOf(new JSONObject()                        .put(tag, j.toString()));
//                        //.put("userMessage","testtest"));
//            	
//            	IDSTrace.log(IDSTrace.WEB_SOCKET, "SEND JSON  "+s);
//            	System.out.println("ALERT SEND JSON "+s);
