...
a. Suivre le guide d’installation de Gradle
...
*Si la configuration est incorrecte, supprimer tous les fichiers ajoutés par Gradle et relancer la commande.*

### Partie 3 : Re-factoriser les dossiers

a. **Déplacer les packages et les fichiers sources**
...
a. **Configurer les fichiers de build**
...
*Il faut donc les créer, vous pouvez voir leurs configurations dans les fichiers annexes à la fin de la page.*

Maintenant que le **build.gradle** contient tout les liens vers les librairies nous pouvons supprimer la plupart des librairies du dossier .tar sauf xminiserver qui est une librairie faites main. Pareil pour le dossier unpacked, il faut grader la librairie mitre.cpe et nmap4j_csl qui sont des librairies locales.

b. **Configurer l’environnement SSL**

Le fichier **cacerts.jks** doit se trouver dans le répertoire App

1. Créer un fichier **properties.gradle**, et y ajouter le code suivant :
