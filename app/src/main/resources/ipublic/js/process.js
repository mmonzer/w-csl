...
(function ($) {
  ...
  class AnalogTank {
    ...
    setInitialValues () {
      this.lookupTableValueEnabled = false; //this.lookupTableValue !== null ? true : false;
      this.changeRateValueEnabled = false; //this.changeRateValue !== null ? true : false;
    ...
    tweenText() {
      ...
      this.behindText
        ...
        .tween("text", function(d) {
          let node = this;
          let interpolate = d3.interpolate(that.textFormatter(node.textContent), that.textFormatter(that.fillValue*5));
...
//let tank = document.getElementById("wrapper").analogTank(options);

//document.getElementById("wrapper").resizable({
