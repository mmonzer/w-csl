 ...
 */
package lib.unpacked.io.jsonwebtoken;

import lib.unpacked.io.jsonwebtoken.security.InvalidKeyException;
import lib.unpacked.io.jsonwebtoken.security.Keys;
...
public enum SignatureAlgorithm {
    ...
    public static SignatureAlgorithm forSigningKey(Key key) throws InvalidKeyException {
        ...
        if (key instanceof SecretKey) {
            ...
            SecretKey secretKey = (SecretKey)key;
            int bitLength = lib.unpacked.io.jsonwebtoken.lang.Arrays.length(secretKey.getEncoded()) * Byte.SIZE;
