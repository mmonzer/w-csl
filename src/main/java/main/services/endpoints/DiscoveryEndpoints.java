...
public enum DiscoveryEndpoints implements Endpoint {
    ...
    GET_ENTITY("get_entity",
            new JsonCmdHelp().setDesc("Retrieve a specific entity from CSL-Scan")
                    .setParam("id", "The uuid of the entity to retrieve", JsonCmdHelp.STR)
                    .setResult("The entity as returned by CSL-Scan", JsonCmdHelp.JSON)
                    .setStatus(JsonCmdHelp.STATUS_OK)),
    DELETE_ENTITY("delete_entity",
            new JsonCmdHelp().setDesc("Remove a specific entity from CSL-Scan")
                    .setParam("id", "The uuid of the entity to delete", JsonCmdHelp.STR)
                    .setResult("<code>{ \"success\": true/false }</code>", JsonCmdHelp.JSON)
                    .setStatus(JsonCmdHelp.STATUS_OK)),
