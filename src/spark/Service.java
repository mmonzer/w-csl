...
public final class Service extends Routable {
    ...
    public synchronized Service externalStaticFileLocation2(String externalFolder) {
        if (initialized && !isRunningFromServlet()) {
            throwBeforeRouteMappingException();
        }
        
        if (!staticFilesConfiguration.isExternalStaticResourcesSet2()) {
            staticFilesConfiguration.configureExternal2(externalFolder);
        } else {
            LOG.warn("External static file location has already been set");
        }
        return this;
    }
    public synchronized Service externalStaticFileLocation3(String externalFolder) {
        if (initialized && !isRunningFromServlet()) {
            throwBeforeRouteMappingException();
        }
        
        if (!staticFilesConfiguration.isExternalStaticResourcesSet3()) {
            staticFilesConfiguration.configureExternal3(externalFolder);
        } else {
            LOG.warn("External static file location has already been set");
        }
        return this;
    ...
    public final class StaticFiles {
        ...
        public void externalLocation2(String externalFolder) {
            externalStaticFileLocation2(externalFolder);
        }
        
        public void externalLocation3(String externalFolder) {
            externalStaticFileLocation3(externalFolder);
        }
        /**
